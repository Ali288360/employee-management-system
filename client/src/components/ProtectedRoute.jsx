...
/**
 * Route protector wrapper supporting role checking
 */
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-slate-950">
        <div className="relative w-16 h-16">
          <div className="absolute top-0 left-0 w-full h-full border-4 border-indigo-500/20 rounded-full animate-ping"></div>
        ...
        <p className="mt-4 text-slate-400 font-medium text-sm animate-pulse">Loading EMS Session...</p>
      </div>
    );
  }
